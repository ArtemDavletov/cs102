...
def messages_get_history(user_id, offset, need_count):
    ...
    plotly.tools.set_credentials_file(username='PLOTLY_USERNAME', api_key='PLOTLY_API_KEY')  # Авторизация в pltly
    try:
...
def message_plotly(users_ids):
    ...
    dates = messages_get_history(54981912, 0, 300)
...
if __name__ == '__main__':
    #print(age_predict(VK_USER_ID))
    #message_plotly(VK_USER_ID_2)
    #drow_graph(VK_USER_ID)
